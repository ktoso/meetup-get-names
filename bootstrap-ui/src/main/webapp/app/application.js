...
angular.module('smlBootstrap', ['smlBootstrap.services', 'smlBootstrap.filters', 'smlBootstrap.controllers', 'ngSanitize', 'ajaxthrobber'])
    ...
    .config(function ($routeProvider) {
        ...
        $routeProvider.
            when('/', {controller: 'MemberController', templateUrl: 'partials/main.html'}).
            when("/error404", {controller: 'MemberController', templateUrl: "partials/errorpages/error404.html"}).
            when("/error500", {controller: 'MemberController', templateUrl: "partials/errorpages/error500.html"}).
            when("/error", {controller: 'MemberController', templateUrl: "partials/errorpages/error500.html"}).
